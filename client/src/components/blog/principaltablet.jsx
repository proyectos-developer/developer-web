...
import blog_principal from '../../assets/images/image_blog_991.png'

export default function PrincipalTablet ({proporcional}){
    return(
        <div style={{width: '100%', height: 800 / proporcional}}>
            <div className='position-relative' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${blog_principal})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
