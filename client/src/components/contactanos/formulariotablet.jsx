...
export default function FormularioTablet ({proporcional}){
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 120 / proporcional, paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
            <div style={{width: '100%', height: 'auto'}}>
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 60 / proporcional}}>
                    <div className='d-flex justify-content-start' style={{width: '50%', height: 60 / proporcional}}>
                        <p style={{fontSize: 14 / proporcional, lineHeight: `${60 / proporcional}px`, fontWeight: 800, color: '#212121', marginBottom: 0 / proporcional, fontFamily: 'Montserrat, sans, serif'}}>
                            {respuesta}
                        </p>
                    </div>
