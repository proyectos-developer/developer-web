...
export default function DetallesCell({proporcional}) {
            ...
            cotizacion && cotizacion.nro_cotizacion ? (
              <div style={{width: '100%', height: 'auto'}}>
                  <div className='d-flex justify-content-center rounded-top' style={{width: '100%', height: 'auto', border: '1px solid #bdbdbd', padding: 10 / proporcional}}>
                      <p style={{fontSize: 28 / proporcional, lineHeight: `${28 / proporcional}px`, marginBottom: 0, color: 'rgb(23, 43, 222)', cursor: 'default', fontWeight: 700, 
                  ...
                  <div style={{width: '100%', height: 'auto', padding: 10 / proporcional, border: '1px solid #bdbdbd', borderTop: ''}}>
                      <div className='' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional}}>
                          <p style={{fontSize: 18 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 10 / proporcional, color: 'black', cursor: 'default', fontWeight: 500, 
                                  fontFamily: 'Hind, sans-serif'}}>
                              Nro cotización: <span style={{fontWeight: 700}}>{cotizacion.nro_cotizacion}</span>
                          </p>
                          <p style={{fontSize: 18 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 0, color: 'black', cursor: 'default', fontWeight: 500, 
                                  fontFamily: 'Hind, sans-serif'}}>
                      ...
                      </div>
                    {
                        cotizacion.tipo_negocio === 'Personal' ? (
                            <div style={{width: '100%', height: 'auto'}}>
                                ...
                                <p style={{fontSize: 22 / proporcional, lineHeight: `${22 / proporcional}px`, marginBottom: 10 / proporcional, color: 'black', cursor: 'default', fontWeight: 800, 
                                ...
                                <p style={{fontSize: 22 / proporcional, lineHeight: `${22 / proporcional}px`, marginBottom: 10 / proporcional, color: 'black', cursor: 'default', fontWeight: 800, 
                                  ...
                                  <div style={{width: '100%', height: 'auto'}}>
                                      <p style={{fontSize: 18 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 0, color: 'black', cursor: 'default', fontWeight: 1000, 
                                              fontFamily: 'Hind, sans-serif'}}>
                    ...
                    }
                    {
                      cotizacion.cotizacion_domhost ? (
                        <div style={{width: '100%', height: 'auto', borderTop: '1px solid #bdbdbd', marginBottom: 20 / proporcional, paddingTop: 10 / proporcional}}>
                            ...
                            <div style={{width: '100%', height: 'auto'}}>
                                <p style={{fontSize: 18 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 0 / proporciona, color: 'black', cursor: 'default', fontWeight: 500, 
                                        fontFamily: 'Hind, sans-serif'}}>
                        ...
                        <div style={{width: '100%', height: 'auto', borderTop: '1px solid #bdbdbd', marginBottom: 20 / proporcional, paddingTop: 10 / proporcional}}>
                          ...
                          <div className='' style={{width: '100%', height: 'auto', marginBottom: 10 / proporcional}}>
                              ...
                              <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                                  ...
                                  <p style={{fontSize: 18 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 0 / proporcional, color: 'black', cursor: 'default', fontWeight: 500, 
