...
export default function Opciones({proporcional}) {
    ...
    return (
        <div className='position-relative'
            style={{width: '100%', height: 'auto', paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional, paddingLeft: 350 / proporcional, paddingRight: 350 / proporcional,
            ...
            <div style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <div className={`${seleccion_opcion === 'dominio' ? 'rounded border' : ''}`} style={{width: '30%', height: 'auto', borderColor: 'white',
                    ...
                    <div className={`${seleccion_opcion === 'web' ? 'rounded border' : ''}`} style={{width: '30%', height: 'auto', borderColor: 'white',
                    ...
                    <div className={`${seleccion_opcion === 'aplicacion' ? 'rounded border' : ''}`} style={{width: '30%', height: 'auto', borderColor: 'white',
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <div className={`${seleccion_opcion === 'marketing' ? 'rounded border' : ''}`} style={{width: '30%', height: 'auto', borderColor: 'white',
                    ...
                    <div className={`${seleccion_opcion === 'software' ? 'rounded border' : ''}`} style={{width: '30%', height: 'auto', borderColor: 'white',
                    ...
                    <div className={`${seleccion_opcion === 'nube' ? 'rounded border' : ''}`} style={{width: '30%', height: 'auto', borderColor: 'white',
