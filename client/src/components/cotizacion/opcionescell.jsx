...
export default function OpcionesCell({proporcional}) {
    ...
    return (
        <div className='position-relative'
            style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional,
            ...
            <div style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <div className={`${seleccion_opcion === 'dominio' ? 'rounded border' : ''}`} style={{width: '90%', height: 'auto', borderColor: 'white',
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <div className={`${seleccion_opcion === 'web' ? 'rounded border' : ''}`} style={{width: '90%', height: 'auto', borderColor: 'white',
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <div className={`${seleccion_opcion === 'aplicacion' ? 'rounded border' : ''}`} style={{width: '90%', height: 'auto', borderColor: 'white',
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <div className={`${seleccion_opcion === 'marketing' ? 'rounded border' : ''}`} style={{width: '90%', height: 'auto', borderColor: 'white',
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <div className={`${seleccion_opcion === 'software' ? 'rounded border' : ''}`} style={{width: '90%', height: 'auto', borderColor: 'white',
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <div className={`${seleccion_opcion === 'nube' ? 'rounded border' : ''}`} style={{width: '90%', height: 'auto', borderColor: 'white',
                ...
                advertencia_seleccion ? (
                    <div className={`position-fixed top-0 start-0 w-100 vh-100`} style={{ display: 'block', zIndex: '99999', background: 'rgba(39, 39, 39, 0.4)' }} id='modal'>
                        <div id='modalcargando' className={`position-fixed top-50 start-50 translate-middle`}
                            ...
                            <div style={{width: 459 / proporcional, height: 'auto', background: 'white'}}>
