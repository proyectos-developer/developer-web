        ...
        <div className='' style={{width: '100%', height: 'auto'}}>
            <div style={{width: '100%', height: 'auto'}}>
                <div className='d-flex justify-content-center rounded-top' style={{width: '100%', height: 'auto', border: '1px solid #bdbdbd', padding: 10 / proporcional}}>
                    <p style={{fontSize: 28 / proporcional, lineHeight: `${28 / proporcional}px`, marginBottom: 0, color: 'rgb(23, 43, 222)', cursor: 'pointer', fontWeight: 700, 
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 50 / proporcional}}>
                <button className='btn' 
                    style={{width: '49%', height: 50 / proporcional, fontSize: 16 / proporcional, color: 'white', background: 'rgb(23, 43, 222)', fontWeight: 600}}
                        onClick={() => volver()}>
                    Volver
                </button>
                <button className='btn' 
