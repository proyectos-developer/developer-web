    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional, paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                <div className='animate__animated animate__fadeInTopLeft' style={{width: '90%', height: 'auto'}}>
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                <div className='animate__animated animate__fadeInRightBig' style={{width: '90%', height: 'auto'}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <div className='rounded-circle' style={{width: 115 / proporcional, height: 115 / proporcional, background: '#172bde', marginBottom: 23 / proporcional}}>
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                <div className='animate__animated animate__fadeInLeftBig' style={{width: '90%', height: 'auto'}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <div className='rounded-circle' style={{width: 115 / proporcional, height: 115 / proporcional, background: '#172bde', marginBottom: 23 / proporcional}}>
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                <div className='animate__animated animate__fadeInBottomLeft' style={{width: '90%', height: 'auto'}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto'}}>
                        <div className='rounded-circle' style={{width: 115 / proporcional, height: 115 / proporcional, background: '#172bde', marginBottom: 23 / proporcional}}>
