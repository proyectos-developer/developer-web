...
export default function ImaginacionTablet ({proporcional}){
    ...
    return (    
        <div style={{width: '100%', height: 1000 / proporcional, backgroundImage: `url(${home_fondo})`, backgroundSize: 'cover', backgroundPosition: 'center', 
            ...
            <div style={{width: '100%', height: 'auto', paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional, paddingRight: 60 / proporcional, paddingLeft: 60 / proporcional}}>
                <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 50 / proporcional}}>
                    <img src={home_diseño} style={{width: '60%', height: '100%'}}/>
                </div>
                <div style={{width: '100%', height: 'auto'}}>
                    ...
                    <div className='d-flex justify-content-center' style={{width: 'auto', height: 'auto'}}>
                        {
                            menu_opcion === 'diseñador' ? (
                                <div style={{width: '60%', height: 'auto', marginTop: 20 / proporcional, textAlign: 'center'}}>
