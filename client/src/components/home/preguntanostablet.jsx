...
export default function PreguntanosTablet ({proporcional}){
    ...
    return (
        <div style={{width: '100%', height: 1000 / proporcional, backgroundImage: `url(${home_fondo_contact})`,
            ...
            <div style={{width: '100%', height: 'auto', paddingTop: 100 / proporcional, paddingBottom: 100 / proporcional, background: 'rgba(189, 189, 189, 0.6)'}}>
                ...
                <div className='d-flex justify-content-center' style={{width: '100%', height: 600 / proporcional, paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional,
