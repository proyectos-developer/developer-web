            ...
            <div id='carouselHomeProyectos' className='carousel slide' data-bs-ride='carousel'>
                <div className='carousel-inner'>
                    <div className='carousel-item active' data-bs-interval='3000'>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 408 / proporcional, marginBottom: 20 / proporcional}}>
                            <div className='d-flex justify-content-center position-relative' style={{width: '90%', height: 408 / proporcional, cursor: 'pointer'}}
                        ...
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 408 / proporcional}}>           
                          <div className='d-flex justify-content-center position-relative' style={{width: '90%', height: 408 / proporcional, cursor: 'pointer'}}
