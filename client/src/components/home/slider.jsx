...
import image_00 from '../../assets/images/home_slider_00_1920.png'
import image_01 from '../../assets/images/home_slider_01_1920.png'
import image_02 from '../../assets/images/home_slider_02_1920.png'
import image_03 from '../../assets/images/home_slider_03_1920.png'
import image_04 from '../../assets/images/home_slider_04_1920.png'
            ...
            <div id='carouselHome' className='carousel slide'>
                ...
                <div className='carousel-inner'>
                    <div className='carousel-item active' data-bs-interval='3500'>
                        <div className='position-relative animate__animated animate__backInLeft' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_00})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                    ...
                    <div className='carousel-item' data-bs-interval='3500'>
                        <div className='position-relative animate__animated animate__bounceInLeft' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_01})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                            <div className='position-absolute top-0 start-0' 
                                    style={{width: '100%', height: 800 / proporcional, background: 'rgba(23, 43, 222, 0.6'}}/>
                            <div className='position-absolute top-50 start-50 translate-middle' style={{width: '80%', height: 'auto'}}>
                                <div className='animate__animated animate__slideInDown' style={{width: '100%', height: 'auto'}}>
                                    ...
                                    <div className='d-flex justify-content-center' style={{width: '100%', height: 60 / proporcional}}>
                                        ...
                                        <button className='btn' style={{width: 180 / proporcional, height: 60 / proporcional, fontSize: 20 / proporcional, fontWeight: 400,
                                            color: '#172bde', background: 'white', marginLeft: 20 / proporcional}}
                                            onClick={() => navigate ('/contactanos')}>Contáctanos</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='carousel-item' data-bs-interval='3500'>
                        <div className='position-relative animate__animated animate__fadeIn' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_02})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                            <div className='position-absolute top-0 start-0' 
                                    style={{width: '100%', height: 800 / proporcional, background: 'rgba(23, 43, 222, 0.6'}}/>
                            <div className='position-absolute top-50 start-50 translate-middle' style={{width: '80%', height: 'auto'}}>
                    ...
                    <div className='carousel-item' data-bs-interval='3500'>
                        <div className='position-relative animate__animated animate__flipInX' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_03})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                            <div className='position-absolute top-0 start-0' 
                                    style={{width: '100%', height: 800 / proporcional, background: 'rgba(23, 43, 222, 0.6'}}/>
                            <div className='position-absolute top-50 start-50 translate-middle' style={{width: '80%', height: 'auto'}}>
                    ...
                    <div className='carousel-item' data-bs-interval='3500'>
                        <div className='position-relative animate__animated animate__zoomIn' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_04})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                            <div className='position-absolute top-0 start-0' 
                                    style={{width: '100%', height: 800 / proporcional, background: 'rgba(23, 43, 222, 0.6'}}/>
                            <div className='position-absolute top-50 start-50 translate-middle' style={{width: '80%', height: 'auto'}}>
