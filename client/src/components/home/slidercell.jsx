...
import image_03 from '../../assets/images/home_slider_03_499.png'
                        ...
                        <div className='position-relative animate__animated animate__backInLeft' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${image_00})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
                            ...
                            <div className='position-absolute top-50 start-50 translate-middle' style={{width: '80%', height: 'auto'}}>
                                <div className='animate__animated animate__jackInTheBox' style={{width: '100%', height: 'auto'}}>
                                    ...
                                    <p style={{fontSize: 20 / proporcional, lineHeight: `${22 / proporcional}px`, fontWeight: 400, fontFamily: 'Hind', marginBottom: 20 / proporcional,
                                            textAlign: 'center', color: 'white'}}>
