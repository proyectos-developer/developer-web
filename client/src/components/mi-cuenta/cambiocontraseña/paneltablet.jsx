...
import CambioPasswordTablet from './cambiopasswordtablet.jsx'

export default function CambiarContraseñaTablet ({proporcional}){
        ...
        <div style={{width: '100%', height: 'auto'}}>
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional,
                ...
                <div style={{width: '80%', height: 'auto'}}>
                    <CambioPasswordTablet proporcional={proporcional}/>
                </div>
            </div>
        </div>
    )
