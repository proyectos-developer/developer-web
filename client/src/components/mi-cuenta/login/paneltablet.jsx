...
import LoginUserTablet from './loginusertablet.jsx'
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            <div className='position-relative' style={{width: '100%', height: 900 / proporcional}}>
                <div className={`position-fixed top-0 start-0 ${position > 900 / proporcional ? 'shadow' : ''}`} style={{width: '100%', height: 100 / proporcional, zIndex: 99999,
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional,
                ...
                <div style={{width: '60%', height: 'auto'}}>
                    <LoginUserTablet proporcional={proporcional}/>
                </div>
            </div>
        </div>
    )
