...
export default function ForgotPasswordCell ({proporcional}){
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            <div style={{width: '100%', height: 80 / proporcional, marginBottom: 15 / proporcional}}>
                <p style={{fontSize: 40 / proporcional, textAlign: 'center', lineHeight: `${40 / proporcional}px`, marginBottom: 0, color: 'rgb(22, 36, 65)', fontWeight: 800, fontFamily: 'Montserrat, sans-serif'}}>
