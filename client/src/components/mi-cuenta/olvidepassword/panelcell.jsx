...
import ForgotPasswordCell from './forgotpasswordcell.jsx'

export default function OlvideContraseñaCell ({proporcional}){
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional,
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    <ForgotPasswordCell proporcional={proporcional}/>
                </div>
            </div>
        </div>
    )
