...
export default function RegisterUserCell ({proporcional}){
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            <div style={{width: '100%', height: 55 / proporcional, marginBottom: 15 / proporcional}}>
                <p style={{fontSize: 40 / proporcional, lineHeight: `${45 / proporcional}px`, textAlign: 'center', marginBottom: 0, color: 'rgb(22, 36, 65)', fontWeight: 800, fontFamily: 'Montserrat, sans-serif'}}>
                    Regístra tus datos
                </p>
            </div>
            <div style={{width: '100%', height: 'auto'}}>
