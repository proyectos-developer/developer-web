...
export default function EquipoCell ({proporcional}){
            ...
            <div style={{width: '100%', height: 'auto'}}>
                <div style={{width: '100%', height: 'auto', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional, paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional}}>
                    <div style={{width: '100%', height: 'auto'}}>
                        ...
                        <p style={{fontSize: 18 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 0, fontWeight: 400, fontFamily: 'Hind, sans-serif',
                ...
                <div className='' style={{width: '100%', height: 'auto', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional,
                    ...
                    <div className='' style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                        <div className='d-flex justify-content-center' style={{width: '90%', height: 'auto', marginBottom: 20 / proporcional}}>
                            <img src={image_equipo_diseñadores} style={{width: '80%'}}/>
                        </div>
                        <div style={{width: '100%', height: 'auto'}}>
