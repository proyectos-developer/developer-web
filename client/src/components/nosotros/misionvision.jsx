...
export default function MisionVision ({proporcional}){
    
    return (
        <div style={{width: '100%', height: 'auto'}}>
            <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '50%', height: 'auto', background: 'rgba(219, 228, 235, 0.8)', paddingTop: 80 / proporcional, paddingBottom: 80 / proporcional, 
                        paddingLeft: 80 / proporcional, paddingRight: 80 / proporcional}}>
