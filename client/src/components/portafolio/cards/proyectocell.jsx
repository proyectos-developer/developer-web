...
export default function CardProyectoTablet({proporcional, proyecto, key, index}) {

    const [seleccion_proyecto, setSeleccionProyecto] = useState('')

    return (
        <div style={{width: '100%',  height: 'auto', cursor: 'pointer'}} onMouseOver={() => setSeleccionProyecto (proyecto.id)} 
