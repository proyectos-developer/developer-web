...
import ServicioTablet from './serviciotablet.jsx'
    ...
    return (
        <div style={{width: '100%', height: 'auto'}}>
            ...
            <div style={{width: '100%', height: 'auto', paddingBottom: 120 / proporcional}}>
                <ServicioTablet proporcional={proporcional}/>
            {
                location.pathname.split ('/')[2] === 'consultoria-digital' || location.pathname.split ('/')[2] === 'soporte-tecnico' ? (
                    ...
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
                            <button className='btn border-0' style={{width: '20%', height: 50 / proporcional, fontSize: 16 / proporcional, color: 'white',
