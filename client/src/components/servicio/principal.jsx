...
import image_consultoria_digital from '../../assets/images/image_consultoria_digital_1920.png'
import image_diseño_web from '../../assets/images/image_diseño_web_1920.png'
import image_aplicacion_movil from '../../assets/images/image_aplicacion_movil_1920.png'
import image_desarrollo_ecommerce from '../../assets/images/image_desarrollo_ecommerce_1920.png'
import image_desarrollo_software from '../../assets/images/image_desarrollo_software_1920.png'
import image_marketing_digital from '../../assets/images/image_marketing_digital_1920.png'
import image_soporte_tecnico from '../../assets/images/image_soporte_tecnico_1920.png'
import image_cloud from '../../assets/images/image_cloud_1920.png'
...
export default function Principal({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 900 / proporcional}}>
            <div className='position-relative' style={{width: '100%', height: 900 / proporcional, backgroundImage: `url(${
