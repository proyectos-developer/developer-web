...
import image_consultoria_digital from '../../assets/images/image_consultoria_digital_991.png'
import image_diseño_web from '../../assets/images/image_diseño_web_991.png'
import image_aplicacion_movil from '../../assets/images/image_aplicacion_movil_991.png'
import image_desarrollo_ecommerce from '../../assets/images/image_desarrollo_ecommerce_991.png'
import image_desarrollo_software from '../../assets/images/image_desarrollo_software_991.png'
import image_marketing_digital from '../../assets/images/image_marketing_digital_991.png'
import image_soporte_tecnico from '../../assets/images/image_soporte_tecnico_991.png'
import image_cloud from '../../assets/images/image_cloud_991.png'
...
export default function PrincipalTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 800 / proporcional}}>
            <div className='position-relative' style={{width: '100%', height: 800 / proporcional, backgroundImage: `url(${
