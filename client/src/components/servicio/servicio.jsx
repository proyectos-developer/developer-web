...
export default function Servicio({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', paddingTop: 120 / proporcional, paddingBottom: 120 / proporcional, paddingLeft: 350 / proporcional,
                paddingRight: 350 / proporcional}}>
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                                ...
                                <div style={{width: '49%', height: '100%'}}>
                                    <div style={{width: '100%', height: 'auto'}}>
                                        ...
                                        <p style={{fontSize: 18 / proporcional, lineHeight: `${22 / proporcional}px`, fontWeight: 500, fontFamily: 'Montserrat', marginBottom: 10 / proporcional,
                                                textAlign: '', color: 'rgba(39, 39, 39, 0.8)'}}>
                                            En un mundo cada vez más digitalizado, la presencia en línea es crucial para el éxito de cualquier negocio. En Developer Ideas, comprendemos la importancia de tener un sitio web profesional, atractivo y funcional que refleje la identidad de tu marca y atraiga a tu audiencia objetivo.<br/>
                                        </p>
                                        <p style={{fontSize: 18 / proporcional, lineHeight: `${22 / proporcional}px`, fontWeight: 500, fontFamily: 'Montserrat', marginBottom: 10 / proporcional,
                                                textAlign: '', color: 'rgba(39, 39, 39, 0.8)'}}>
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                                ...
                                <div style={{width: '49%', height: '100%'}}>
                                    <div style={{width: '100%', height: 'auto'}}>
                                        ...
                                        <p style={{fontSize: 18 / proporcional, lineHeight: `${22 / proporcional}px`, fontWeight: 500, fontFamily: 'Montserrat', marginBottom: 10 / proporcional,
                                                textAlign: '', color: 'rgba(39, 39, 39, 0.8)'}}>En un mundo donde las compras en línea son cada vez más comunes, tener una plataforma de comercio electrónico sólida y efectiva es fundamental para el éxito de tu negocio. En Developer Ideas, entendemos la importancia de una experiencia de compra en línea sin problemas y atractiva para tus clientes.<br/>
                                        </p>
                                        <p style={{fontSize: 18 / proporcional, lineHeight: `${22 / proporcional}px`, fontWeight: 500, fontFamily: 'Montserrat', marginBottom: 10 / proporcional,
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                                ...
                                <div style={{width: '49%', height: '100%'}}>
                                    <div style={{width: '100%', height: 'auto'}}>
                                        ...
                                        <p style={{fontSize: 18 / proporcional, lineHeight: `${22 / proporcional}px`, fontWeight: 500, fontFamily: 'Montserrat', marginBottom: 10 / proporcional,
                                                textAlign: '', color: 'rgba(39, 39, 39, 0.8)'}}>
                                            En un mundo cada vez más complejo y digitalizado, entender cómo aprovechar al máximo la tecnología es fundamental para el éxito de cualquier negocio. En Developer Ideas, entendemos la importancia de tener una estrategia digital sólida y efectiva que te permita alcanzar tus objetivos comerciales.<br/>
                                        </p>
                                        <p style={{fontSize: 18 / proporcional, lineHeight: `${22 / proporcional}px`, fontWeight: 500, fontFamily: 'Montserrat', marginBottom: 10 / proporcional,
                                                textAlign: '', color: 'rgba(39, 39, 39, 0.8)'}}>
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 20 / proporcional}}>
                                ...
                                <div style={{width: '49%', height: '100%'}}>
                                    <div style={{width: '100%', height: 'auto'}}>
                                        ...
                                        <p style={{fontSize: 18 / proporcional, lineHeight: `${22 / proporcional}px`, fontWeight: 500, fontFamily: 'Montserrat', marginBottom: 10 / proporcional,
                                                textAlign: '', color: 'rgba(39, 39, 39, 0.8)'}}>
                                            En un mundo cada vez más dependiente de la tecnología, es crucial contar con un equipo confiable de expertos en soporte técnico que esté siempre disponible para resolver cualquier problema que surja. En Developer Idea, comprendemos la importancia de mantener tu infraestructura tecnológica en óptimas condiciones para garantizar la continuidad del negocio.<br/>
                                        </p>
                                        <p style={{fontSize: 18 / proporcional, lineHeight: `${22 / proporcional}px`, fontWeight: 500, fontFamily: 'Montserrat', marginBottom: 10 / proporcional,
                                                textAlign: '', color: 'rgba(39, 39, 39, 0.8)'}}>
