...
import shop_principal from '../../assets/images/shop_principal.png'

export default function Principal ({proporcional}){
    return(
        <div style={{width: '100%', height: 900 / proporcional}}>
            <div className='position-relative' style={{width: '100%', height: 900 / proporcional, backgroundImage: `url(${shop_principal})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
